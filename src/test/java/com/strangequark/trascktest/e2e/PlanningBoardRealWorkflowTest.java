...
class PlanningBoardRealWorkflowTest {
    ...
    void realBackendPlanningBoardReleaseAndRoadmapWorkflowUsesBrowserUi() {
        ...
        try (Playwright playwright = Playwright.create();
            ...
            JsonNode roadmapRecord = apiSession.requireJson(apiSession.post(
                    "/api/v1/workspaces/" + workspace.workspaceId() + "/roadmaps",
                    JsonSupport.object(
            ...
            JsonNode roadmapItem = apiSession.requireJson(apiSession.post(
                    "/api/v1/roadmaps/" + roadmapRecord.path("id").asText() + "/items",
                    JsonSupport.object("workItemId", seed.workItem().path("id").asText())
            ), 201);
            cleanup.delete(apiSession, "/api/v1/roadmaps/" + roadmapRecord.path("id").asText()
